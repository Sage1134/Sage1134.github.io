...
document.addEventListener('DOMContentLoaded', function() {
    const events = [
        ...
        { title: 'Steam Day', description: 'Many grade 8 students were initially excited about STEAM day. However, there was some disappointment when a few mentors withdrew last minute, causing a scramble to find replacements that were less prepared.' },
        ...
        { title: 'Grade 8 Tour', description: 'The grade 8 tour at the end of semester 2 showed moderate success as a result of well planned activities. Unfortunately some enthusiasm was lost by the mentors during the outside activities following the tours of the inside of the school.' },
        { title: 'Grade 8/9 Night', description: 'The Grade 8/9 Night was successful, thanks to in depth planning and enthusiastic mentor participation in guiding groups. The groups led by the mentors showed appreciation to the support from the group leaders.' },
